...
export const ui = {
  vi: {
    ...
    "equipment.content": "Bình Phát Construction sở hữu số lượng lớn máy móc, thiết bị xây dựng hiện đại, đa dạng và đầy đủ đáp ứng mọi yêu cầu của các dự án xây dựng lớn nhỏ. Công ty đầu tư vào hệ thống máy móc tiên tiến như máy xúc, máy ủi, cần cẩu, xe lu, máy đào, và các thiết bị chuyên dụng khác, đảm bảo khả năng thi công nhanh chóng, chính xác và an toàn.",
