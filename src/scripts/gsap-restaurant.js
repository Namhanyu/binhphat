...
export function initRestaurantAnimations() {
  ...
  gsap.utils.toArray(".card-image-overlay-item").forEach((item, index) => {
    gsap.fromTo(
      item,
      {
        y: 30,
      ...
      },
      {
        ...
        delay: index * 0.1,
        scrollTrigger: {
          trigger: item.closest(".accommodation-side") || item,
          start: "top 80%",
          end: "bottom 20%",
          toggleActions: "play none none reverse",
        },
